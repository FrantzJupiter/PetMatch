...
- Navegação circular entre os animais disponíveis.
- Ações para recolocar animais na fila e salvá-los como favoritos.
- Área para revisar e remover animais favoritos.
